...
require_once '../settings/core.php'; // Ensure core.php is available for functions like isAdmin()
...
// The database column for user ID in the categories table is 'created_by'
...
<head>
    <meta charset="UTF-8">
    <title>Admin Dashboard - TasteConnect</title>
...
<body class="p-4 bg-light">
    ...
    <div class="container">
        ...
        <h4 class="text-secondary mb-3">Category Moderation Queue</h4>
