...
// Get the initial search query from the URL (e.g., from the homepage form)
...
<body>
    ...
    <div class="container my-5">
        <h1 class="mb-4 text-center">Search Results for: "<?= $initialQuery ?>"</h1>

        <div class="filter-section row g-3">
            <div class="col-md-5">
                <input type="text" id="searchQuery" class="form-control" placeholder="Refine your search..." value="<?= $initialQuery ?>">
            </div>
            
            <div class="col-md-3">
                <select id="categoryFilter" class="form-select">
                    <option value="0">Narrow by Category</option>
            ...
            <div class="col-md-3">
                <select id="brandFilter" class="form-select">
                    <option value="0">Narrow by Brand/Vendor</option>
    ...
    <script src="../js/productfrontend.js"></script> 
</body>
</html>